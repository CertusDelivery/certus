...
Delivery.delete_all
deliveries = []
deliveries << Delivery.new(order_sku_count: 3, order_status: 'PICKING', shipping_address: "test shipping_address")
deliveries << Delivery.new(order_sku_count: 3, order_status: 'PICKING', shipping_address: "test shipping_address")
deliveries << Delivery.new(order_sku_count: 3, order_status: 'PICKING', shipping_address: "test shipping_address")
deliveries << Delivery.new(order_sku_count: 3, order_status: 'UNPICKED', shipping_address: "test shipping_address")
deliveries << Delivery.new(order_sku_count: 3, order_status: 'UNPICKED', shipping_address: "test shipping_address")
deliveries << Delivery.new(order_sku_count: 3, order_status: 'UNPICKED', shipping_address: "test shipping_address")
...
deliveries.each do |delivery|
    delivery.delivery_items << [
      DeliveryItem.create(picked_status: '1/0/0/0', product_name: 'Special K Cereal - Strawberry', quantity: 1,
        ...
        picker_bin_number: '12400', store_sku: '6143854', client_sku: '6143854'),
      DeliveryItem.create(picked_status: '2/0/0/0', product_name: 'Purell Hand Sanitizer', quantity: 2,
        ...
        picker_bin_number: '12345', store_sku: '073852400908', client_sku: '073852400908'),
      DeliveryItem.create(picked_status: '1/1/0/0', product_name: 'Diet Coke', shipping_weight: '12.6', quantity: 1,
        ...
        store_sku: '073852400908', client_sku: '073852400908')]
   delivery.save
end